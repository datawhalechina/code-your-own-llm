...
| 章节                                                    | 摘要                         | 状态 |
| ------------------------------------------------------- | ---------------------------- | ---- |
| [第1章 引言](Chapter01/Introduction.md)          | 项目概述以及学习建议         | ✅    |
| [第2章 环境配置](Chapter02/Environment.md)       | 开发环境搭建与硬件要求解析   | ✅    |
| [第3章 数据](Chapter03/Data.md)                  | 数据采集、清洗及质量评估     | ✅    |
| [第4章 分词](Chapter04/Tokenization.md)          | 分词算法原理与词表构建实践   | 🚧    |
| [第5章 模型架构](Chapter05/Architecture.md)      | 从零实现模型核心架构         | ✅    |
| [第6章 预训练](Chapter06/Pretrain.md)            | 大规模预训练的目标与优化策略 | 🚧    |
| [第7章 中期训练](Chapter07/Midtrain.md)          | 领域适应与持续学习技术       | 🚧    |
| [第8章 有监督微调](Chapter08/SFT.md)             | 指令微调与参数高效微调方法   | ✅    |
| [第9章 强化学习](Chapter09/RL.md)                | 强化学习与模型偏好对齐       | ✅    |
| [第10章 模型推理](Chapter10/Inference.md)        | 高效推理与量化加速技术       | 🚧    |
| [第11章 模型评估](Chapter11/Evaluation.md)       | 评估指标体系与基准测试方法   | 🚧    |
| [第12章 模型安全与红队测试](Chapter12/Safety.md) | 安全对齐与红队测试实践       | 🚧    |
| [附录](Appendix/README.md)                       | 数学基础与前沿论文解读       | 🚧    |
